--[[
    CircledAvatarImage
    ## Use it like simple AvatarImage but with ***:SetMaskSize(*** / 2) at the end where *** is a variable of CircledAvatarImage panel.
]]
...
vgui.Register("CircledAvatarImage", PANEL)